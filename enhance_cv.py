...
Your task is to improve and structure the PROJECTS section of a CV.

Instructions:

1. Collect all projects mentioned in the CV, including:
   - personal projects
   - academic projects
   - labs
   - projects from learning platforms

2. Merge all projects into **one unified PROJECTS section** — do not create separate sections for labs or platform projects.

3. Remove duplicates if the same project appears more than once.

4. **Sort all projects by date in descending order** (most recent first, oldest last), **regardless of whether they are originally from the CV or from platform labs**.

5. Format each project as follows:

PROJECTS

- **Project Name** — Year  
  One concise line describing what was built and the technologies used.

6. The description must:
   - be **one line only**
   - highlight **technologies and tools**
   - use **action-oriented language**
   - be **optimized for technical recruiters and ATS systems**

Example:

PROJECTS

- **Machine Learning Basics** — 2025  
  Completed a lab project focusing on foundational machine learning techniques with a score of 94/100.

- **Python Data Analysis** — 2025  
  Developed data analysis skills through a hands-on lab project, scoring 88/100.

- **Advanced SQL & Optimization** — 2025  
  Enhanced SQL skills and query optimization techniques in a lab project, achieving a score of 91/100.

- **Customer Churn Prediction Model** — 2023  
  Built a machine learning model using Python and Scikit-learn achieving 87% accuracy on a dataset of 50,000 customers for a telecom company simulation.

- **Sales Dashboard** — 2023  
  Designed an interactive dashboard tracking KPIs for a retail dataset using Power BI, reducing report generation time by 60% compared to manual processes.

Important:  
All projects, whether from the CV or platform labs, must be **ordered from most recent to oldest**.
